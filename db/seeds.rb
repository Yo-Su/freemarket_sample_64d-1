...
child_grandchild_array.each do |child_grandchild|
  if child_grandchild == child_array[children_id_cnt][0]
    grandchild_array << ['その他',children_id_cnt + 13]
    children_id_cnt += 1
  else
    grandchild_array << [child_grandchild,children_id_cnt + 13]
  end
end
