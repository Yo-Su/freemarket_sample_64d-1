$(function(){
  ...
  $('.content__item-data__photo__sub-images__sub-image').on('mouseover', function(e){
    ...
    // 全部の画像を非表示にする
    $('.content__item-data__photo__main-image__pickupimage').each(function(index, element){
    ...
    // 全部の画像に透明度を設定する
    $('.content__item-data__photo__sub-images__sub-image').each(function(index, element){
